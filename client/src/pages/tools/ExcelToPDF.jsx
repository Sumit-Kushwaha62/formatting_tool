        ...
        {!result ? (
          <>
            ...
            >
              ...
              <div className="dropzone-text">Click or drag Excel file here</div>
              <div className="dropzone-sub">Supports single .xlsx file</div>
              <input 
                id="fileInput"
                type="file" 
                accept=".xlsx"
            ...
            >
              {loading ? <div className="spinner" style={{ width: 18, height: 18, margin: 0 }} /> : 'Convert to PDF'}
            </button>
          </>
        ) : (
