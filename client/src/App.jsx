...
const WORD_SPACINGS = [
  ...
  { value: 'wide',    label: 'Wide',    desc: 'Slightly wider' },
  { value: 'wider',   label: 'Wider',   desc: 'More space' },
  { value: 'widest',  label: 'Widest',  desc: 'Maximum space' },
];
          ...
          <div>
            ...
            <div className="content-card">
              ...
              <div className="format-section orange">
                <div className="format-section-title">↔ Word Spacing</div>
                ...
                <div style={{marginTop:'10px',fontSize:'.75rem',fontWeight:500,color:formData.word_spacing?'#C2410C':'#9CA3AF'}}>
                  {formData.word_spacing?`✓ Selected: ${formData.word_spacing.charAt(0).toUpperCase()+formData.word_spacing.slice(1)}`:'Default: Normal spacing'}
                </div>
              </div>
